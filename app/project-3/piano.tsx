...
export default function Piano() {
  function handleClick(e: React.MouseEvent<HTMLAnchorElement>): void {
    e.preventDefault();
    const audio = new Audio(`audio/${e.currentTarget.getAttribute("data-value")}.mp3`);
    audio.play();
  }
